 ...
 */
public class _MessageDlg extends Window {
	private Message _msg;
	private Rows rows;
	private String _nickname;
	private ChatRoom _chatRoom;

	public _MessageDlg(Message msg, String nickname, ChatRoom chatRoom)
	...
	public void setRecieve() {
		...
		replyBtn.addEventListener("onClick", new EventListener() {
			public void onEvent(Event e) throws Exception {
				...
				_MessageDlg.this.detach();
				_MessageDlg msgDlg = new _MessageDlg(_msg, _nickname, _chatRoom);
				msgDlg.setSend();
