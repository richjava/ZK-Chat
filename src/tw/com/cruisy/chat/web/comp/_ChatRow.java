...
import tw.com.cruisy.chat.web._MessageDlg;
 ...
 * chat users.
 */
public class _ChatRow extends Row {

	public _ChatRow(final Message msg, final ChatRoom chatRoom, ChatUser chatUser) {
			...
			if (chatUser.isIMEnabled() && msg.getSender().compareTo(nickname)!=0) {
				...
				pmImg.addEventListener("onClick", new EventListener() {
					public void onEvent(Event e) throws Exception {
						_MessageDlg msgDlg = new _MessageDlg(msg, nickname,
								chatRoom);
						msgDlg.setSend();
